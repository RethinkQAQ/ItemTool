                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Integer>createBuilder()
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("itemtool.settings.font_size.name"))
                                        .description(OptionDescription.of(Text.translatable("itemtool.settings.font_size.desc")))
                                        .binding(10, () -> ItemToolConfig.fontSize, newVal ->  ItemToolConfig.fontSize = newVal)
                                        .controller(opt -> IntegerFieldControllerBuilder.create(opt).range(1,50))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        ...
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("itemtool.settings.item_name.name"))
                                        .description(OptionDescription.of(Text.translatable("itemtool.settings.item_name.desc")))
                                        .binding(false, () -> ItemToolConfig.ItemName, newVal ->  ItemToolConfig.ItemName = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
